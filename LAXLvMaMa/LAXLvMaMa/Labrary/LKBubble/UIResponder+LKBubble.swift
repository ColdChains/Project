...
extension UIResponder{
    ...
    ///
    /// - returns: 泡泡信息描述对象
    static func getDefaultRightBubbleInfo() -> LKBubbleInfo {
    ...
    ///
    /// - returns: 泡泡信息描述对象
    static func getDefaultRoundProgressBubbleInfo() -> LKBubbleInfo {
        let info: LKBubbleInfo = LKBubbleInfo()
        info.iconAnimation = {(layer: CAShapeLayer) -> Void in
        ...
        info.backgroundColor = UIColor.clear//UIColor(red: 0.1, green: 0.1, blue: 0.1, alpha: 0.8)
        return info
    }
    ...
    ///
    /// - returns: 泡泡信息描述对象
    static func getDefaultErrorBubbleInfo() -> LKBubbleInfo {
        let info: LKBubbleInfo = LKBubbleInfo()
